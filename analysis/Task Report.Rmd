...
output:
  html_document:
    ...
    number_sections: yes
    self_contained: yes
    css: "C:/Users/nick.dawe/Documents/R Projects Via Git/Microsoft Planner/corp-styles.css"
  pdf_document:
    toc: no
---
...
---
title: "`r paste0("TASK REPORT <br>", toupper(plan_name_to_filter), ': WEEK ', lubridate::isoweek(Sys.Date()))`"
---
...
wk_report <- current_week_report %>% 
  ...
  mutate(completion.ratio = round(Ontime/planned.tasks.due, 2),
         completion.percent = scales::percent(Ontime/planned.tasks.due, accuracy = 1)) %>% 
...
During the previous reporting week (`r wk_report[2, 1]`), **`r wk_report[2, 10]`** of planned tasks were completed on-time, with a four week rolling average completion rate of **`r  scales::percent(as.numeric(completion_ratio[6, 11]))`**.
